        ...
        <div className="w-full max-w-3xl mb-32">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
            {members.map((member, index) => (
              <div 
                key={index}
                className="h-48 w-44 relative bg-white overflow-hidden rounded-2xl flex flex-col border border-gray-300 transition-all duration-300"
                style={{ 
              ...
              >
                <div className="p-3 flex flex-col gap-1">
                  <div className="text-black text-sm font-semibold leading-5 text-center">
                    {member.name}
                  </div>
                  <div className="text-black text-opacity-60 text-xs font-medium leading-4 text-center">
                    {member.description}
                  </div>
                </div>
                <img 
                  className="w-28 h-28 absolute left-1/2 transform -translate-x-1/2 top-16 rounded-2xl border-3 border-white"
                  style={{ boxShadow: '0px 3px 12px rgba(0, 0, 0, 0.08)' }}
                  src={member.image} 
                  alt={member.name}
                />
                ...
                >
                  <a
                    ...
                    className="w-8 h-8 bg-white bg-opacity-90 rounded-full flex items-center justify-center hover:bg-opacity-100 transition-all duration-200 shadow-lg"
                  >
